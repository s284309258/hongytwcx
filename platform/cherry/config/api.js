// const API_BASE_URL = 'http://192.168.10.137:8082/platform_framework/api/';
// const API_BASE_URL = 'https://zfpay.mylcwl.com:1443/platform/api/';
// const API_BASE_URL = 'http://192.168.10.137:28080/platform/api/';
const API_BASE_URL = 'https://www.mtmzg.cn/api/';
module.exports = {
    ...
    Collage:  API_BASE_URL + 'goods/listPindan', //拼单列表
    moneyInfo:  API_BASE_URL + "center/info",    //金额信息
    applyInfo:   API_BASE_URL + 'center/withdrawApply' ,//提交申请
    CenterInfo:   API_BASE_URL + 'center/getMyCenterInfo' ,//提现信息
    consumerInfo:   API_BASE_URL + 'center/consumerRecordByUserID' ,//销售信息
    bankInfo:   API_BASE_URL + 'center/bankInfoByID' ,//销售信息
    upGrade:API_BASE_URL + 'center/upGrade' ,//升级信息
    prepay:API_BASE_URL + 'center/prepay' ,//升级支付
    getPhoneNumber:API_BASE_URL + 'center/getPhoneNumber' ,//获取手机号码
   getCheckPrice:API_BASE_URL + 'center/getGoodsSpecification',//获取选择商品到价格
   getCartDetail:API_BASE_URL + 'center/recentConsumeList',//获取购买详情
};
