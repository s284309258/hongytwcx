...
public class ApiOrderController extends ApiBaseAction {
    ...
    public Object listState(@LoginUser UserVo loginUser,@RequestParam("pay_status") String pay_status,@RequestParam("order_status") String order_status,@RequestParam("take_way") String take_way,@RequestParam(value = "page", defaultValue = "1") Integer page,
    ...
    public Object list(@LoginUser UserVo loginUser,
        ...
        for (OrderVo item : orderEntityList) {
            ...
            //订单的商品
            List<OrderGoodsVo> goodsList = orderGoodsService.queryList(orderGoodsParam);
            item.setOrderGoodsVoList(goodsList);
            Integer goodsCount = 0;
            for (OrderGoodsVo orderGoodsEntity : goodsList) {
                goodsCount += orderGoodsEntity.getNumber();
                item.setGoodsCount(goodsCount);
