...
public class ApiProductService {
    ...
    public String getSpecificationPicture(String id,String goods_id){
        String[] params = id.split("_");
        List arrays = Arrays.asList(params);
        return productDao.getSpecificationPicture(arrays,goods_id);
    }
