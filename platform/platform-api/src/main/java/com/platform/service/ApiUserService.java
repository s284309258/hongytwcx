...
public class ApiUserService {
    ...
    public void insertBankAccount(UserVo userVo){
        userDao.insertBankAccount(userVo);
    }
    ...
    public UserLevelVo getUserLevelVo(UserVo loginUser){
        return userLevelDao.queryObject(loginUser.getUser_level_id());
    }

    public int updateLevelUnderUserDaili(Long user_id){
        return userDao.updateLevelUnderUserDaili(user_id);
    }

    public int updateLevelUnderUserHuoheren(Long user_id){
        return userDao.updateLevelUnderUserHuoheren(user_id);
    }

    public int updateTaskNum0(Long user_id){
        return userDao.updateTaskNum0(user_id);
    }
}
