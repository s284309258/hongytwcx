...
public class Sqlca {
	...
	private static Logger logger = Logger.getLogger(Sqlca.class);
	...
	{
		logger.info("=============Sqlca:updateObject============="+sql+"==========objs========={}"+objs);
		int cnt = 0;
	...
	{
		logger.info("=============Sqlca:getString============="+sql);
		String obj = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		try
...
//		Connection conn = getConnection();
	...
	public static ArrayList<Map<String,Object>> getArrayListFromMap(String sql,Connection conn) {
		logger.info("=============Sqlca:getArrayListFromMap============="+sql);
	...
	public static ArrayList<Object> getArrayListFromObj(String sql,Class<?> clss,Connection conn){
		logger.info("=============Sqlca:getArrayListFromObj============="+sql);
